...
1. [🔧 Tools](#-tools)
   ...
   - [1.4. Web Application Security](#14-web-application-security)
   - [1.5. Network Traffic Analysis](#15-network-traffic-analysis)
   - [1.6. Intrusion Detection and Prevention](#16-intrusion-detection-and-prevention)
   - [1.7. Endpoint Security](#17-endpoint-security)
...
2. [💻 Open-Source Codes](#-open-source-codes)
   ...
   - [2.4. Network Monitoring](#24-network-monitoring)
   - [2.5. Configuration and Automation](#25-configuration-and-automation)
